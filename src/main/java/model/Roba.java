...
public class Roba {
    ...
    @DatabaseField(columnName = POLJE_VISINA)
    private double visina;
    @DatabaseField(columnName = POLJE_DUZINA)
    private double duzina;
    @DatabaseField(columnName = POLJE_SIRINA)
    ...
    public void setVisina(double visina){this.visina = visina;}

    public double getDuzina(){return duzina;}

    public void setDuzina(double duzina){this.duzina = duzina;}

    public double getSirina(){return sirina;}

    public void setSirina(double sirina){this.sirina = sirina;}
